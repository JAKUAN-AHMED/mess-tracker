...
int _memberEstimateSize(
  ...
  bytesCount += 3 + object.joinDate.length * 3;
...
void _memberSerialize(
  ...
  writer.writeString(offsets[2], object.joinDate);
...
Member _memberDeserialize(
  ...
  final object = Member(
    ...
    joinDate: reader.readString(offsets[2]),
...
extension MemberQueryFilter on QueryBuilder<Member, Member, QFilterCondition> {
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'joinDate',
        value: '',
  ...
  QueryBuilder<Member, Member, QAfterFilterCondition> joinDateIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'joinDate',
        value: '',
...
extension MemberQueryProperty on QueryBuilder<Member, Member, QQueryProperty> {
  ...
  QueryBuilder<Member, String, QQueryOperations> joinDateProperty() {
    return QueryBuilder.apply(this, (query) {
