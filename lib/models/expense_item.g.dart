...
void _expenseItemSerialize(
  ...
  writer.writeString(offsets[0], object.itemName);
...
ExpenseItem _expenseItemDeserialize(
  ...
  final object = ExpenseItem(
    itemName: reader.readStringOrNull(offsets[0]) ?? '',
...
extension ExpenseItemQueryFilter
  ...
  QueryBuilder<ExpenseItem, ExpenseItem, QAfterFilterCondition> itemNameBetween(
    String lower,
    String upper, {
  ...
  QueryBuilder<ExpenseItem, ExpenseItem, QAfterFilterCondition> itemNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseItem, ExpenseItem, QAfterFilterCondition> priceEqualTo(
    double value, {
  ...
  QueryBuilder<ExpenseItem, ExpenseItem, QAfterFilterCondition> priceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<ExpenseItem, ExpenseItem, QAfterFilterCondition> priceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
